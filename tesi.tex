...
\begin{proof}
	...
	\begin{equation}\label{Cauchy Schwartz lemma uncertainty principle}
	...
	\begin{align*}
		|\langle (A-a)f, (B-b)f \rangle| &\geq \frac{1}{2}\left| \langle (A-a)f, (B-b)f \rangle - \langle (B-b)f, (A-a)f \rangle \right| =\\
										 &=| \langle Af,Bf \rangle - \langle Af,bf \rangle - \langle af,Bf \rangle + \langle af,bf \rangle +\\
										 &\phantom{|} - \langle Bf,Af \rangle + \langle Bf,af \rangle + \langle bf,Af \rangle - \langle bf,af \rangle |
	\end{align*}
\end{proof}
